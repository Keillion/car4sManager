...
<div class="wrapper">
    ...
    <div class="main-title clearfix ">
        <h2><?php if($sign == 'add'): ?>新增<?php else: ?>编辑<?php endif; ?>友情连接</h2>
    </div>
    <!-- 表单 -->
    <form id="form" action="<?php echo U('Admin/SuperLinks/update');?>" method="post" class="form-horizontal">
        <!-- 基础文档模型 -->
        <div id="tab1" class="tab-pane with-padding in tab1">
            ...
            <div class="form-item cf">
                ...
                <div class="controls ">
                    <?php if($sign == 'add'): ?><label class="radio-inline"><input type="radio" class="radio-inline"  name="type" value="2" checked="checked"  onclick="javascript:hide_img()">普通连接</label>
