...
<?php switch($field["type"]): case "text": ?><input type="text" name="<?php echo ($field["name"]); ?>" value="<?php echo (htmlspecialchars($field["value"])); ?>"
    ...
    <?php case "icon": ?><div class='icon-chose' title=<?php echo L("_SELECT_ICON_WITH_DOUBLE_");?> style="width: 400px;">
        ...
        <script src="/opensns/Application/Admin/Static/zui/lib/chosen/chosen.icons.min.js"></script>
        <link href="/opensns/Application/Admin/Static/zui/lib/chosen/chosen.icons.css" rel="stylesheet">
        <?php } ?>
        <script>
            $(function(){
...
<script type="text/javascript">
    ...
    <?php if($chosen_select2): ?><link rel="stylesheet" href="/opensns/Application/Admin/Static/adminlte/plugins/select2/select2.min.css">
        <script src="/opensns/Application/Admin/Static/adminlte/plugins/select2/select2.full.min.js"></script>
        <script>
            $(function(){
                $(".select2").select2();
            })
        </script><?php endif; ?>
    <?php if($has_nestable): ?><link href="/opensns/Application/Admin/Static/bootstrap/plugins/jquery-nestable/jquery.nestable.css" rel="stylesheet" type="text/css"/>
        <script src="/opensns/Application/Admin/Static/bootstrap/plugins/jquery-nestable/jquery.nestable.js" type="text/javascript"></script>
        <script src="/opensns/Application/Admin/Static/bootstrap/js/ui-nestable.min.js" type="text/javascript"></script>
        <script>
    ...
    <?php if($importDatetimePicker): ?><link href="/opensns/Application/Admin/Static/bootstrap/plugins/datetimepicker/datetimepicker.css" rel="stylesheet" type="text/css">
        <script type="text/javascript" src="/opensns/Application/Admin/Static/bootstrap/plugins/datetimepicker/datetimepicker.min.js"></script>
    ...
    <?php if($colorPicker): ?><script type="text/javascript" src="/opensns/Application/Admin/Static/js/jquery.simple-color.js"></script>
        <script>
            $(function(){
