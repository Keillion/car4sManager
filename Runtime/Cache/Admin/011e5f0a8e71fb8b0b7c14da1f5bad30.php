...
<script>
    ...
    <div class="pull-left nav_list">
        ...
        <select name="nav[1][modul][]" class="form-control module" style="width: 110px;<?php if(!$nav['module_name']){ ?>display:none<?php } ?>">
        ...
        <input name="nav[1][title][]" placeholder=<?php echo L("_PLEASE_ENTER_THE_TITLE_WITH_DOUBLE_");?> class="form-control title" style="width: 110px;" value="<?php echo ($nav["title"]); ?>">
    ...
    <div class='pull-left band-text'>
        <input name="nav[1][band_text][]" class="form-control" placeholder=<?php echo L("_SIGN_POINTS_WITH_DOUBLE_");?>  style="width: 110px;" value="<?php echo ($nav['band_text']); ?>">
    </div>
