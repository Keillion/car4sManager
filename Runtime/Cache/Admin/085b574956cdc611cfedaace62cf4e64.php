        ...
        <div class="portlet-body">
            <div>
                ...
                <div class="tiles tile-group ten-wide ">
                    ...
                    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$data): $mod = ($i % 2 );++$i;?><div class="live-tile accent exclude tile-id" id="tile_<?php echo ($data['id']); ?>" data-speed="750" data-delay="3000" style="background-color: <?php echo ($data['tile_bg']); ?>">
...
<script type="text/javascript">
    ...
    <script src="/opensns/Application/Admin/Static/bootstrap/plugins/counterup/jquery.waypoints.min.js" type="text/javascript"></script>
    <script src="/opensns/Application/Admin/Static/bootstrap/plugins/counterup/jquery.counterup.min.js" type="text/javascript"></script>
    <link href="/opensns/Application/Admin/Static/bootstrap/plugins/metro/MetroJs.min.css" type="text/css" rel="stylesheet">
    <script src="/opensns/Application/Admin/Static/bootstrap/plugins/metro/MetroJs.min.js" type="text/javascript"></script>
    <script type="text/javascript" src="/opensns/Application/Admin/Static/js/highcharts.js"></script>
    <script type="text/javascript" src="/opensns/Application/Admin/Static/adminlte/plugins/jQueryUI/jquery-ui.min.js"></script>

    <script src="/opensns/Application/Admin/Static/js/jquery.simple-color.js"></script>
    <link rel="stylesheet" href="/opensns/Application/Admin/Static/css/tile.css" media="all">
    ...
    <script>
        ...
        $('[data-role=saveCountSetting]').click(function () {
            $.post("/opensns/index.php?s=/admin/index/index.html", {count_day: $('[name=count_day]').val()}, function (msg) {
                handleAjax(msg);
            });
        });
