<?php if (!defined('THINK_PATH')) exit();?><div id="adv_<?php echo ($pos["id"]); ?>" class="adv-wrap" style="padding: <?php echo ($pos["padding"]); ?>;margin:<?php echo ($pos["margin"]); ?>;">
    <div class="text-left " style="width:<?php echo ($pos["width"]); ?>;height:<?php echo ($pos["height"]); ?>;">
        <?php if(count($list) > 0): switch($pos["style"]): case "2": ?><script src="/opensns/Public/js/ext/kinmaxshow/js/kinmaxshow.min.js"></script>
                ...
                <?php default: ?>
                <script src="/opensns/Public/js/ext/touchslide/js/jquery.touchSlider.js"></script>
                <link href="/opensns/Public/js/ext/touchslide/css/touchslider.css" rel="stylesheet" type="text/css"/>
                <div class="main_visual"  style="height: <?php echo ($pos["height"]); ?>;width:<?php echo ($pos["width"]); ?>;display: none">
                    ...
                    <div class="main_image" style="width:<?php echo ($pos["width"]); ?>;">
                        <ul>
