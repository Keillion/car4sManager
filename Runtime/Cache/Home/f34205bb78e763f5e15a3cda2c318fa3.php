...
<?php echo hook('pageHeader');?>
    <link href="/opensns/Application/Home/Static/css/static_home.css" rel="stylesheet" type="text/css"/>
</head>
<body>
<!-- 头部 -->
    ...
    <div class="client-wrap">
        <div class="container client-box">
            ...
            <div class="row client">
                <div class="col-xs-3">
                    <div class="content">
                        <img src="/opensns/Application/Home/Static/images/ali.png"  class="img-responsive">
                ...
                <div class="col-xs-3">
                    <div class="content">
                        <img src="/opensns/Application/Home/Static/images/qw.png"  class="img-responsive">
                        <p class="p-bold">旅游--去玩吗</p>
                        <p style="text-indent: 2em">去玩吗，户外旅游社区电商平台致力于解决国人“玩”的问题，主要关注户外休闲资源供应的整合与消费端群体的集聚。</p>
                        <p style="text-indent: 2em">去玩吗使用OpenSNS系统的活动、专辑、问答、论坛、积分商城等模块，以户外休闲旅游为切入点，打造国内首家以“泛户外”为主题的户外旅游社区电商平台。</p>
                        <div class="hide-box"><a href="http://www.quwan.ma/" target="_blank"><i class="os-icon-link"></i></a></div>
                    </div>
                </div>
                <div class="col-xs-3">
                    <div class="content">
                        <img src="/opensns/Application/Home/Static/images/xq.png"  class="img-responsive">
                ...
                <div class="col-xs-3">
                    <div class="content">
                        <img src="/opensns/Application/Home/Static/images/km.png"  class="img-responsive">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-xs-2 comp">
                <p class="p-head">公司</p>
                <a href="http://www.ourstu.com/joinus.html" target="_blank">
                    <p><i class="icon icon-user"></i>加入我们</p>
                </a>
                <p><i class="icon icon-phone-sign"></i>400-0573-080</p>
                <p><i class="icon icon-envelope-alt"></i>co@ourstu.com</p>
            </div>
        </div>
