        ...
        <div class="row shop">
            <div class="col-xs-12   clearfix">
                <div class="col-xs-12 common_block_border pad_15">
                    <?php if($top_category == ''): ?><h2 class="title_content"><?php echo L('_PRODUCT_ALL_');?></h2>
                        <?php else: ?>
                        <h2 class="title_content"><?php echo L('_CATEGORY_');?>&nbsp;->&nbsp;<a
                    ...
                    <?php if(is_array($contents)): $i = 0; $__LIST__ = $contents;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="col-xs-3 goods">
                            <div class="item_goods position_re">
                                ...
                                <dl>
                                    ...
                                    <dd>
                                        ...
                                        <div class="right" style="color: #d61f39;"><a><font title="<?php echo L('_NEED_');?>$money_type.title}"><i
                                                class="ico_to_money"></i>&nbsp;<?php echo ($vo["money_need"]); ?></font></a></div>
                    ...
                    <?php if(count($contents) == 0): ?><div style="font-size:3em;padding:2em 0;color: #ccc;text-align: center"><?php echo L('_TIP_CATEGORY_PRODUCT_NONE_');?>
                        </div><?php endif; ?>
                </div>
            </div>
