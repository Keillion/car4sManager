...
<script src="/opensns/Public/js.php?f=js/jquery-2.0.3.min.js,js/com/com.functions.js,static/os-loading/loading.js,js/core.js,js/com/com.toast.class.js,js/com/com.ucard.js"></script>
    ...
    <link href="/opensns/Application/Ucenter/Static/css/usercenter.css" rel="stylesheet" type="text/css"/>
...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <?php if($user_info['cover_id']): ?><img class="uc_top_img_bg" src="<?php echo ($user_info['cover_path']); ?>" style="width: 100%;height: 100%">
        <?php else: ?>
        <img class="uc_top_img_bg" src="/opensns/Application/Ucenter/Static/images/user_top_default_bg.jpg" style="width: 100%;height: 100%"><?php endif; ?>
    <?php if(is_login() && $user_info['uid'] == is_login()): ?><div class="change_cover"><a data-type="ajax" data-url="<?php echo U('Ucenter/Public/changeCover');?>" data-toggle="modal" data-title="<?php echo L('_UPLOAD_PERSONAL_COVER_');?>" style="color: white;"><img class="img-responsive" src="/opensns/Application/Core/Static/images/fractional.png"></a>
        </div><?php endif; ?>
    <div class="avt-wrap">
        ...
        <div class="bottom-wrap row">
            ...
            <?php if(is_login() && $user_info['uid'] != get_uid()): ?><div class="col-xs-4 bt-group">
                <?php echo W('Common/Follow/follow',array('follow_who'=>$user_info['uid']));?>
                <button type="button" class="btn btn-default" onclick="talker.start_talk(<?php echo ($user_info['uid']); ?>)"><?php echo L('_CHAT_');?>
                </button>
            </div><?php endif; ?>
        </div>
    </div>
