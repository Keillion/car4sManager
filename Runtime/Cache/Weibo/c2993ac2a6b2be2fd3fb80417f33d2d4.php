...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <script type="text/javascript" src="/opensns/Public/js/ajaxfileupload.js"></script>
    <link href="/opensns/Application/Weibo/Static/css/weibo.css" type="text/css" rel="stylesheet"/>
    <link href="//at.alicdn.com/t/font_1473390548_975161.css" type="text/css" rel="stylesheet"/>
    ...
    <link href="/opensns/Public/js/ext/webuploader/css/webuploader.css" type="text/css" rel="stylesheet"><?php endif; ?>
...
<?php if(empty($lastId) == false): ?><script>
    ...
    <?php if(is_login()): ?><div class="my-community">
            <div class="ck-sign">
                <?php if(!$check){ ?>
                <img src="/opensns/Application/Weibo/Static/images/checking.png" alt="">
                <?php }else{ ?>
                <img src="/opensns/Application/Weibo/Static/images/checked.png" alt="">
                <?php } ?>
            </div>
...
<script src="/opensns/Public/js/ext/lazyload/lazyload.js"></script>
    ...
    <script src="/opensns/Application/Weibo/Static/js/weibo.js"></script>
    <script>
    ...
    <link rel="stylesheet" href="/opensns/Application/Weibo/Static/css/photoswipe.css">
    <link rel="stylesheet" href="/opensns/Application/Weibo/Static/css/default-skin/default-skin.css">
    <script src="/opensns/Application/Weibo/Static/js/photoswipe.min.js"></script>
    <script src="/opensns/Application/Weibo/Static/js/photoswipe-ui-default.min.js"></script>
