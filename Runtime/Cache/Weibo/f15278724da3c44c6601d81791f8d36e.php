<?php if (!defined('THINK_PATH')) exit();?><link type="text/css" rel="stylesheet" href="/opensns/Public/zui/lib/calendar/zui.calendar.min.css"/>
...
<script type="text/javascript" src="/opensns/Public/zui/lib/calendar/zui.calendar.js"></script>
<script>
    $(function () {
        do_checkin();
        check_in_calender();
