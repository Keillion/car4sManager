...
<!--顶部导航之后的钩子，调用公告等 end-->
    ...
    <?php
 $img_id = modC('JUMP_BACKGROUND','','config'); if($img_id){ $background =get_cover($img_id,'path'); }else{ $background = '/openSNS/Public/images/jump_background.jpg'; } ?>
...
<?php }?>
    ...
    <p class="jump">
        ...
        或 <a href="http://<?php echo ($_SERVER['HTTP_HOST']); ?>/openSNS" style="color: green">返回首页</a>
    </p>
